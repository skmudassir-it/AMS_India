...
const projects = [
  ...
  { name: "Spark Electric", url: "https://spark-electric-six.vercel.app", description: "Modern electrical services site with portfolio, reviews, and estimate requests.", gradient: "from-yellow-500 to-amber-600" },
  ...
  { name: "Pro Plumber", url: "https://plumber-services-alpha.vercel.app", description: "Plumbing services with emergency response, pricing, and service areas.", gradient: "from-blue-500 to-indigo-600" },
  ...
  { name: "NestKey", url: "https://nestkey-nu.vercel.app", description: "Real estate platform with property listings, search, and agent profiles.", gradient: "from-teal-500 to-emerald-600" },
  ...
  { name: "Property Hub", url: "https://property.amsitservices.com", description: "Real estate property management with listings and tenant portal.", gradient: "from-emerald-600 to-green-700" },
  ...
  { name: "Mindful Hypnotherapy", url: "https://hypnotherapy-sandy.vercel.app", description: "Professional hypnotherapy services with sessions and wellness blog.", gradient: "from-violet-400 to-purple-500" },
  ...
  { name: "Drone Photography", url: "https://drone-photography-sigma.vercel.app", description: "Aerial drone photography and videography with gallery and booking.", gradient: "from-sky-600 to-cyan-700" },
  ...
  { name: "RV Repair Pro", url: "https://rv-repair-pearl.vercel.app", description: "RV and camper repair services with mobile fleet and scheduling.", gradient: "from-emerald-700 to-green-800" },
