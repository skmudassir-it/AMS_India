...
export const metadata: Metadata = {
    ...
    description: "Browse AMS IT Services' portfolio of 58+ custom websites, mobile apps, and e-commerce stores built for clients worldwide.",
    ...
    openGraph: {
        ...
        description: "Explore 58+ professional websites, mobile apps, and digital projects delivered by AMS IT Services.",
