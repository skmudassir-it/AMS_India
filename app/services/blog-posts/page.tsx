...
export default function BlogPostsPage() {
    const scopeItems = [
        { title: "Weekly Series", desc: "Building consistent momentum with recurring topical blog series.", icon: PenTool },
        { title: "Viral Content", desc: "Expertly crafted think-pieces designed for social sharing and visibility.", icon: Share2 },
        { title: "Engagement Mgmt", desc: "Managing comments and reader interactions to build a community.", icon: MessageSquare },
        { title: "SEO Freshness", desc: "Regular updates that signal search engines your site is active and authoritative.", icon: Zap }
    ]

    const processSteps = [
        { step: "01", title: "Audit", desc: "Analyzing your current blog performance and audience interest.", icon: Search },
        { step: "02", title: "Calendar", desc: "Establishing a strict editorial calendar for consistent delivery.", icon: Workflow },
        { step: "03", title: "Production", desc: "Writing and designing rich media for every single post.", icon: PenTool },
        { step: "04", title: "Distribution", desc: "Strategic sharing across LinkedIn, Twitter, and niche communities.", icon: Activity },
        { step: "05", title: "Analyze", desc: "Reviewing metrics to inform the next month's content strategy.", icon: TrendingUp }
    ]

    const blogFeatures = [
        { title: "Authority Setup", icon: Shield, desc: "Content that establishes you as a primary expert in your field." },
        { title: "Reader Loyalty", icon: Heart, desc: "Building a dedicated following through consistent value delivery." },
        { title: "Data Driven", icon: TrendingUp, desc: "Topics selected based on high-intent search data and trends." },
        { title: "Visual Rich", icon: Library, desc: "Custom infographics and layouts for every single blog post." }
    ]
        ...
        <div className="bg-white">
                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    <div className="flex-1 space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-600 text-xs font-black uppercase tracking-[0.2em]">
                            <TrendingUp className="h-4 w-4" /> Community & Growth
                        </div>
                        <h1 className="text-6xl md:text-8xl font-black text-primary leading-[0.9] tracking-tighter italic">
                            Blog <br />
                            <span className="text-rose-600">Posts.</span>
                        </h1>
                        <p className="text-xl text-slate-600 leading-relaxed max-w-xl font-medium">
                            Keep your brand alive. We create engaging, regular, and value-packed blog posts that build community and boost your SEO rankings.
                        </p>
                        <div className="flex flex-wrap gap-4 pt-4">
                            <Button size="lg" className="bg-rose-600 hover:bg-rose-700 rounded-full px-12 h-16 text-lg font-black italic shadow-2xl shadow-rose-500/20" asChild>
                                <Link href="/contact">Start Your Blog</Link>
                            </Button>
                        </div>
                    </div>
                        ...
                        <div className="relative aspect-square bg-slate-50 rounded-[4rem] border-8 border-white shadow-3xl overflow-hidden p-12">
                            <div className="grid grid-cols-2 gap-6 h-full">
                                <div className="bg-white rounded-3xl shadow-xl p-6 flex flex-col justify-center items-center gap-4 transform rotate-3">
                                    <Library className="h-12 w-12 text-rose-600" />
                                    <div className="h-2 bg-slate-100 rounded-full w-full" />
                                    <div className="h-2 bg-slate-100 rounded-full w-2/3" />
                                </div>
                                <div className="bg-rose-600 rounded-3xl shadow-xl p-6 flex flex-col justify-center items-center gap-4 transform -rotate-3 translate-y-8">
            ...
            <section className="bg-slate-50 py-24 md:py-32">
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mb-16">
                        ...
                        <p className="text-xl text-slate-600 font-medium">Providing high-frequency, high-value content to fuel your social growth.</p>
                    </div>
            ...
            <section className="container mx-auto px-4 py-24 md:py-32">
                <div className="text-center max-w-4xl mx-auto mb-20 space-y-6">
                    ...
                    <p className="text-xl text-slate-600">A strict editorial process that ensures your blog stays fresh and engaging.</p>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-10">
                            ...
                            <p className="text-xl text-slate-400 font-medium">
                                We utilize modern social triggers and SEO freshness data to ensure your blog is more than just an archive.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                {blogFeatures.map((item, idx) => (
            ...
            <section className="container mx-auto px-4 py-24 mb-20">
                <div className="bg-gradient-to-br from-rose-600 to-rose-800 p-12 md:p-24 rounded-[4rem] text-center space-y-10 shadow-3xl relative overflow-hidden">
                    ...
                    <h2 className="text-4xl md:text-7xl font-black text-white italic leading-none">Ready to start the conversation?</h2>
                    <p className="text-xl text-rose-100 max-w-2xl mx-auto font-medium opacity-80">
                        Let's build a vibrant blog that keeps your brand top-of-mind and fuels your organic growth strategy.
                    </p>
                    <div className="pt-6">
