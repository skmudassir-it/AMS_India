...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        images: [{ url: "/services/content-writing.png", width: 1200, height: 630, alt: "Content Writing Services" }],
    },
    twitter: { card: "summary_large_image", images: ["/services/content-writing.png"] },
}
